...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0014000000000015, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFMODAnimNotifyPlay, Event), Z_Construct_UClass_UFMODEvent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_Event_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_Event_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_AttachName = { "AttachName", nullptr, (EPropertyFlags)0x0010000000000011, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFMODAnimNotifyPlay, AttachName), METADATA_PARAMS(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_AttachName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_AttachName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_bFollow = { "bFollow", nullptr, (EPropertyFlags)0x0010000000000011, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UFMODAnimNotifyPlay), &Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_bFollow_SetBit, METADATA_PARAMS(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_bFollow_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::NewProp_bFollow_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::PropPointers),
		0,
		0x001120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UFMODAnimNotifyPlay_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UFMODAnimNotifyPlay, 966392638);
